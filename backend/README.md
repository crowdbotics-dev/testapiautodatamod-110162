...
## Project Structure
    ...
    ├── testapiautodatamod_110162  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_110162`
...
2. Clone this repo and `cd testapiautodatamod_110162`
